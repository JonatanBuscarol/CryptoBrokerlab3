<template>
  <div class="buy-screen-container">
    <div class="buy-screen">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div v-if="cryptoAmount && currentPrice">
          ...
          <p>Total a pagar: {{ totalCost }} ARS</p>
        </div>
        ...
        <div>
          <label for="purchaseDate">Fecha y hora de compra:</label>
          <input
    ...
    async handleSubmit() {
      ...
      try {
        ...
        if (response) {
          ...
          this.errorMessage = "Hubo un error al registrar la compra.";
        }
      } catch (error) {
